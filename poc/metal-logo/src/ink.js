...
// in it. It lives apart from vector.js so the export path can reach it without
// dragging opentype.js (173KB) along with it.
//
...
// The outlines moved to outline.js, which has no Clipper in it; re-exported
// here so art.js and the export path see no change.
export { branchOutline } from './outline.js'

/* The Clipper plumbing. Only the export path reaches any of this now. */
const SCALE = 100
